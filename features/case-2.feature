Feature: Loggin out from the whole CAS service 
    ...
    Scenario Outline:
        ...
        And I have logged in <nodeForLoggin> with a valid "username" and "password"
        ...
        Examples:
            ...
            |     node1     |       node1    |      node2       |      node 3       |
            |     node1     |       node2    |      node1       |      node 3       |
            |     node1     |       node3    |      node1       |      node 2       |
            |     node1     |       node1    |      node1       |      node 3       |
            |     node1     |       node2    |      node2       |      node 3       |
            |     node1     |       node3    |      node3       |      node 2       |
            |     node2     |       node1    |      node2       |      node 3       |
            |     node2     |       node2    |      node1       |      node 3       |
            |     node2     |       node3    |      node1       |      node 2       |
            |     node2     |       node1    |      node1       |      node 3       |
            |     node2     |       node2    |      node2       |      node 3       |
            |     node2     |       node3    |      node3       |      node 2       |
            |     node3     |       node1    |      node2       |      node 3       |
            |     node3     |       node2    |      node1       |      node 3       |
            |     node3     |       node3    |      node1       |      node 2       |
            |     node3     |       node1    |      node1       |      node 3       |
            |     node3     |       node2    |      node2       |      node 3       |
            |     node3     |       node3    |      node3       |      node 2       |
